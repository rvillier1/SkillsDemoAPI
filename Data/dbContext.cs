...
namespace SkillsDemoAPI.Data
{
    public partial class dbContect : DbContext
    {
        private readonly string ConString;

        public dbContect(string constring)
        {
            ConString = constring;
        }
        ...
        public virtual DbSet<EmployeeForDisplay> EmployeeData { get; set; } // your new DbQuery
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeForDisplay>(entity =>
            {
                entity.HasNoKey();
